#ifndef __mpid_iovec_util__h__
#define __mpid_iovec_util__h__
                         ...
                         size_t               *target_iovs_nout)
{
  ...
  size_t    len,last_len;
  ADI_COMPILE_TIME_ASSERT(offsetof(iovec_t,iov_base)==offsetof(rma_iov_t,addr));
  ADI_COMPILE_TIME_ASSERT(offsetof(iovec_t,iov_len)==offsetof(rma_iov_t,len));
